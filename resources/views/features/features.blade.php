                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example" >
                                             <a class="btn btn-primary" href="features/edit/{{$feature->id}}">Edit</a>

                                            <button  class="btn btn-danger" data-toggle="modal" data-target="#deleted{{$feature->id}}">Delate</button>
                                        </div>
                                    </td>
                                </tr>

                                 @include('features.deleted')
                            @endforeach
                            </tbody>
                        </table>
                    </div>
